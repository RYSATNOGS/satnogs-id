...
def patch_rffit(path: str | Path = "/opt/strf/rffit.c") -> None:
    """Rewrite rffit.c in place, adding the headless `-I` identify flag. Idempotent anchors
    make each replacement fail loudly if upstream strf has changed under us."""
